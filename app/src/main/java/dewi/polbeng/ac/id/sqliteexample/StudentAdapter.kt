package dewi.polbeng.ac.id.sqliteexample
import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import dewi.polbeng.ac.id.sqliteexample.databinding.ItemListStudentBinding
...
class StudentAdapter (private val studentList:
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):
            ListViewHolder {
        val binding =
            ItemListStudentBinding.inflate(LayoutInflater.from(parent.context),
                parent, false)
